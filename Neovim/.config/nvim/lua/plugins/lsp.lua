...
return {
  {
    ...
    config = function(_, opts)
      ...
      local on_attach = function(client, bufnr)
        ...
        -- nmap("<leader>lsr", vim.lsp.buf.rename, "Rename")
        -- nmap("<leader>lsf", require("telescope.builtin").lsp_document_symbols, "Find")

        -- nmap("<leader>lwa", vim.lsp.buf.add_workspace_folder, "Add Folder")
        -- nmap("<leader>lwd", vim.lsp.buf.remove_workspace_folder, "Remove Folder")
        -- nmap("<leader>lws",
        --   function()
        ...
        -- nmap("<leader>lLi", "<CMD>LspInfo<CR>", "LSP Info")
        -- nmap("<leader>lLr", "<CMD>LspRestart<CR>", "LSP Restart")
        -- nmap("<leader>lLm", "<CMD>Mason<CR>", "Mason")

        -- nmap("<leader>lc", vim.lsp.buf.code_action, "Code Action")
        -- nmap("<leader>li", vim.lsp.buf.signature_help, "Signature Documentation")
        -- nmap("<leader>ld", vim.diagnostic.open_float, "Diagnostic Float")
        ...
        -- nmap("K", vim.lsp.buf.hover, "Documentation Float")
